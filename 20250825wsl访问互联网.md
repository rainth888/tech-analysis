...
```bash
curl -I --proxy http://***:***@leiyu-pc:~$ curl -I --proxy http://***:***@leiyu-pc:~$ curl -I --socks5-hostname 127.0.0.1:7891 https://***:***@leiyu-pc:~$ curl -I --proxy http://***:***@leiyu-pc:~$ curl -I --socks5-hostname 172.19.128.1:7891 https://httpbin.org/ip
^C
bill@leiyu-pc:~$
```
